...
public class PlayerData {
    final static String rep = "src"+File.separator+"main"+File.separator+"resources"+File.separator+"Data"+File.separator+"Save"+File.separator;
    static String FILENAME = rep+ "save.properties";
    static String HERO_REP = rep+"heroes"+File.separator;
